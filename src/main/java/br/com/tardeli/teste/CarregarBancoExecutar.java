...
public class CarregarBancoExecutar {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        Persistence.createEntityManagerFactory("atividade");
        ...
        Projeto pj_2 = new Projeto("Projeto-2", false, false, ve_2);
        Projeto pj_3 = new Projeto("Projeto-3", false, true, ve_3);
        Projeto pj_4 = new Projeto("Projeto-4", true, false, ve_1);
        Projeto pj_5 = new Projeto("Projeto-5", true, true, ve_4);
        Projeto pj_6 = new Projeto("Projeto-6", true, false, ve_2);
        Projeto pj_7 = new Projeto("Projeto-7", false, true, ve_1);
        Projeto pj_8 = new Projeto("Projeto-8", false, false, ve_5);
        Projeto pj_9 = new Projeto("Projeto-9", true, true, ve_4);
        Projeto pj_10 = new Projeto("Projeto-10", false, false, ve_1);
        Projeto pj_11 = new Projeto("Projeto-11", true, false, ve_3);
        Projeto pj_12 = new Projeto("Projeto-12", false, false, ve_5);
