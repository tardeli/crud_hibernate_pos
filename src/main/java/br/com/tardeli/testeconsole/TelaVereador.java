...
public class TelaVereador {
    ...
    public void salvarConsole() {
        ...
        partido = partidoControle.buscarPartidoPorCodigo(Long.parseLong(codigo));
        ...
        if (vereadorControle.salvarOuAtualizar(v)) {
    ...
    public void atualizarConsole() {
        ...
        try {
            ...
            obj = vereadorControle.buscarVereadorPorCodigo(Long.parseLong(codigo));
            ...
            if (vereadorControle.salvarOuAtualizar(obj)) {
    ...
    public void listarConsole() {
        for (Vereador obj : vereadorControle.listarTodos()) {
            System.out.println(obj.toString());
        }
    }
    ...
    public void buscarVereadorPorPartido() {
        ...
        try {
            ...
            partido = partidoControle.buscarPartidoPorCodigo(Long.parseLong(cod));
            listaObjs = vereadorControle.buscarVereadoresPorPartido(partido);
    ...
    public void buscarDadosVereadorPorNome() {
        ...
        try {
            Vereador vereador = vereadorControle.buscarDadosVereadorPorNome(nome);
